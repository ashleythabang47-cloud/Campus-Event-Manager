...
- Automatic waitlist using a Queue
- Save events to a file
- Load saved events when the application starts
...
4. Follow the on-screen menu to access the Student or Staff functionalities.
